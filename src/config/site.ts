...
export interface TrustClaims {
  ...
  /** Service runs around the clock, every day. Gates every "24/7" string. */
  is24x7: boolean;
  /** Lowest current price (AED) for a supplied + fitted battery. */
  startingPriceAed: number | null;
  /** Battery / charging-system test offered free of charge. */
  freeTesting: boolean;
...
export const siteConfig: SiteConfig = {
  ...
  /*
    Claims below were confirmed by the current lead partner (Sep 2026).
    They describe the service a visitor actually receives through the CTAs.
    ⚠️ If the partner changes (e.g. after a sale), re-confirm every one of
    these with the new operator — or set it back to null/false.
  */
  claims: {
    ...
    freeTesting: true,
    paymentMethods: "Cash, card and bank transfer",
  },
    ...
    bands: [
      {
        ...
        spec: "35–45 Ah",
        fits: "Yaris, Sunny, Accent, Picanto and similar small cars without stop-start",
        low: 120,
        high: 380,
      },
      {
