...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 180 180">
  <rect width="180" height="180" fill="#0B1017" />
  <path d="M90 39 L56 96 H84 L78 141 L124 79 H96 Z" fill="#FFD23F" />
</svg>`;
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32">
  <rect x="1" y="1" width="30" height="30" rx="9" fill="#0B1017" />
  <path d="M16 7 L10 17 H15 L14 25 L22 14 H17 Z" fill="#FFD23F" />
</svg>`;
